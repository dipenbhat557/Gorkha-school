...
const Messages = () => {
  return (
    <div className="w-[95%] h-[930px] md:h-[450px] mt-4 mb-2 mx-auto">
      <div className="border-dashed border-b-4 rounded-xl mx-auto border-blue-400" />
      <div
        className="bg-blue-400 w-[80px] h-[16%] flex justify-start mt-0.5 ml-[30px] rounded-b-xl"
